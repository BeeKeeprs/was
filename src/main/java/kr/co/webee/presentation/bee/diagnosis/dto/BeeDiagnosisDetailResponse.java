...
@Builder
public record BeeDiagnosisDetailResponse(
    ...
    public static BeeDiagnosisDetailResponse from(BeeDiagnosis beeDiagnosis) {
        return BeeDiagnosisDetailResponse.builder()
                .imageUrl(beeDiagnosis.getImageUrl())
                .diseaseType(beeDiagnosis.getDiseaseType())
                .confidence(beeDiagnosis.getConfidence())
                .cropName(beeDiagnosis.getCropName())
                .cultivationType(beeDiagnosis.getCultivationType())
                .cultivationAddress(beeDiagnosis.getCultivationAddress())
                .details(beeDiagnosis.getDetails())
                .situationAnalysis(beeDiagnosis.getSituationAnalysis())
                .solutions(beeDiagnosis.getSolutions())
