package kr.co.webee.application.ai.tool;
...
public class DateTimeTools {
    ...
    @Tool(description = "주어진 시간에 알람을 설정한다.")
    private void setAlarm(
    		@ToolParam(description = "알람을 울릴 시간") LocalDateTime alarmTime,
    		String osName) throws IOException, InterruptedException {
